...
class PostgresManager(metaclass=SingletonMeta):
    ...
    async def ensure_business_schema(self):
        ...
        stmts = [
            ...
            "ALTER TABLE IF EXISTS schedule_snapshots ADD COLUMN IF NOT EXISTS source_schema_version VARCHAR(128)",
            "ALTER TABLE IF EXISTS schedule_snapshots ADD COLUMN IF NOT EXISTS adapter_id VARCHAR(128)",
            "ALTER TABLE IF EXISTS schedule_snapshots ADD COLUMN IF NOT EXISTS adapter_version VARCHAR(64)",
            "ALTER TABLE IF EXISTS schedule_snapshots ADD COLUMN IF NOT EXISTS source_document_sha256 VARCHAR(80)",
            "ALTER TABLE IF EXISTS schedule_snapshots ADD COLUMN IF NOT EXISTS source_document_object VARCHAR(1024)",
            "ALTER TABLE IF EXISTS schedule_snapshots ADD COLUMN IF NOT EXISTS normalization_report JSONB",
